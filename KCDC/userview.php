...
if (isset($_POST['Save'])) {
  ...
  if ($temp_shift->num_rows > 0) {
    ...
    while ($row =  $temp_shift->fetch_assoc()) {
      ...
      insert_shift_schedule($row['shift_id'], $row['preferred_date'], $row['shift'], $patient_last_name,);
    }
            ...
            <div class="modal-body">
              <form>
                <div class="mb-3">
                  ...
                  <!-- check_schedule() -->
                  <input type="date" name="preferred_date" id="preferred_date" class="form-control" min="<?php echo date('Y-m-d'); ?>">
      ...
      <section class="content">
        ...
        <script>
          ...
          document.getElementById("preferred_date").addEventListener("change", function() {
            const datee = document.getElementById("preferred_date").value;
            var selectedDate = new Date(document.getElementById("preferred_date").value);
            console.log(datee);
            var daysOfWeek = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
            var selectedDayOfWeek = daysOfWeek[selectedDate.getDay()];
            // document.getElementById("selectedDay").innerHTML = "You selected " + selectedDayOfWeek + ".";
