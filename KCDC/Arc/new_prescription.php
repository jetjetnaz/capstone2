...
if(isset($_POST['submit'])) {
  ...
  try {
    ...
    `next_visit_date`, `bp`, `weight`, `patient_id`) 
    VALUES('$visitDate', 
...
<head>
 ...
 <title>New Prescription - Kidney Care and Dialysis Center</title>
...
include './config/sidebar.php';?>  
    ...
    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
      <label>&nbsp;</label>
      <button id="add_to_list" type="button" class="bg-purple btn btn-primary btn-sm btn-flat btn-block">
  ...
  <div class="row table-responsive">
    <table id="medication_list" class="table table-striped table-bordered text-">
      <colgroup>
        <col width="10%">
        <col width="50%">
        <col width="10%">
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      class="bg-purple btn btn-primary btn-sm btn-flat btn-block">Save</button>
    </div>
  </div>
</form>
