          ...
          <form method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-4">
                ...
                <!-- <select id="update_funds" class="form-control" name="source_funds">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <!-- <select id="income" class="form-control " name="source_income">
              ...
              <div class="col-md-6">
                ...
                <!-- <select id="update_assistance" class="form-control" name="source_assistance">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#update_shift_modal">
              Transfer to a vacant shift
            </button>
          </div>
          <!-- reschedule patients -->
          <div class="mb-3">
