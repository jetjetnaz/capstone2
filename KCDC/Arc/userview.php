...
if (isset($_POST['Save'])) {
  ...
  $patient_contact_of_companion = $_POST['contact_number_companion'];
  ...
  // $patient_questionOne = $_POST['questionOne'];
  // $patient_questionTwo = $_POST['questionTwo'];
  ...
  if ($temp_shift->num_rows > 0) {
    ...
    while ($row =  $temp_shift->fetch_assoc()) {
      ...
      insert_patients($row['shift_id'], $row['shift'], $patient_last_name, $patient_first_name, $patient_middle_name, $patient_age,  $patient_gender, $patient_religion, $patient_date_birth, $patient_address, $patient_contact_number, $patient_barangay_city, $patient_social_media, $patient_attending_physician, $patient_name_of_companion, $patient_contact_of_companion,  $patient_years_of_dialysis_facility, $patient_frequency_of_treatment, $row['preferred_date'], $patient_hospital_affiliated, $patient_old_dialysis_facility, $patient_relationship_with_patient, $patient_source_funds, $patient_source_income, $patient_source_assistance);
          ...
          <div class="card-body">
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>Age </label>
                  <input type="number" id="age" name="age" class="form-control form-control-sm rounded-0" required="required" />
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  ...
                  <input id="religion" name="religion" class="form-control form-control-sm rounded-0" required="required" />
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>Contact No. of Companion</label>
                  <input type="tel" type="text" id="contact_number_companion" name="contact_number_companion" class="form-control form-control-sm rounded-0" required="required" />
                </div>

                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>Relatiobship with patient</label>
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  ...
                  <input type="number" id="years_treatment" name="years_treatment" class="form-control form-control-sm rounded-0" required="required" />
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  ...
                  <input type="number" id="frequency_treatment" name="frequency_treatment" class="form-control form-control-sm rounded-0" required="required" onchange="on_change()" />
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>How can ARC help you? (Paano ka matutulungan ng ARC?)</label>
                  <textarea rows="5"  id="questionOne" class="form-control form-control-sm rounded-0" name="questionOne"></textarea>
                </div>
              <!-- <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>What other assistance</label>
                  <textarea rows="10"  id="source_assistance" class="form-control form-control-sm rounded-0" name="questionOne"></textarea>
                </div> -->
              <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>Comments and Suggestions</label>
                  <textarea rows="5"  id="questionTwo" class="form-control form-control-sm rounded-0" name="questionTwo"></textarea>
                </div>
            ...
            $.ajax({
              ...
              success: (res) => {
                ...
                if (res.B < 8) {
                  ...
                  shift_b.innerHTML = `B : Not Available (` + res.B + `)`;
                }
                ...
                if (res.C < 8) {
                  ...
                  shift_c.innerHTML = `C : Not Available (` + res.C + `)`;
                }
