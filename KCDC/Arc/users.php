            ...
            <form method="post" enctype="multipart/form-data">
             <div class="row">
              ...
              <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                ...
                name="save_user" class="bg-purple btn btn-primary btn-sm btn-flat btn-block">Save</button>
              </div>
            </div>
          </form>
        </div>
         ...
         <tbody>
          ...
          while($row = $stmtUsers->fetch(PDO::FETCH_ASSOC)) {
           ...
           <tr>
             ...
             <td class="px-2 py-1 align-middle text-center">
                <a href="update_user.php?user_id=<?php echo $row['id']; ?>" class="bg-purple btn btn-primary btn-sm btn-flat">
